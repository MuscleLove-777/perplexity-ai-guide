...
def run(config, prompts=None):
    ...
    try:
        ...
        from seo_optimizer import PerplexitySEOOptimizer
        ...
        optimizer = PerplexitySEOOptimizer(config)
    ...
    try:
        from site_generator import PerplexitySiteGenerator
        site_gen = PerplexitySiteGenerator(config)
        site_gen.build_site()
